...
const DiscoverButton = (props) => {
  return (
    <div>
      <button className="overflow-hidden w-48 p-2 h-12 bg-black text-white border-none rounded-md text-xl font-bold cursor-pointer relative z-10 group" onClick={props.onClick}>
        Login!
        ...
        <span className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-2.5 left-8 z-10 text-black">
          Admin Only!
        </span>
      </button>
    </div>
