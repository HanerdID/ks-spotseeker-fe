...
const CreateWisata = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append("name", wisata.name);
    formData.append("description", wisata.description);
    formData.append("location", wisata.location);
