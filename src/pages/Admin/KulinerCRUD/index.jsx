...
import KulinerTable from "../../../components/KulinerTable";
import CreateKuliner from "../../../components/CreateKuliner";
    ...
    <div>
      ...
      <div className="flex w-dvw h-auto justify-center">
        <div className="container bg-slate-200 mt-4 p-8 rounded-xl space-y-4">
          <p className="text-center font-semibold text-3xl">Kuliner Data</p>
